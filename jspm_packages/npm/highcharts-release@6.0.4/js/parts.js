...
(function(process) {
  ...
  var HighchartsConfig = {
    'version': [{'highcharts': '4.0.1-modified'}, {'Highstock': '2.0.1-modified'}],
    'parts': [{
      'name': 'Intro',
      'component': 'Core',
      'group': 'Core',
      ...
      'group': 'Features',
      'baseUrl': 'parts',
      'depends': {'component': ['Core']}
    }, {
      'name': 'VmlRenderer',
      'component': 'VML renderer',
      'group': 'Renderers',
      'depends': {'component': ['Html']},
      'baseUrl': 'parts'
    }, {
      'name': 'Tick',
      'component': 'Core',
      ...
      'component': 'Touch',
      'group': 'Dynamics and Interaction',
      'depends': {'component': ['Interaction', 'Core']},
      'baseUrl': 'parts'
    }, {
      'name': 'MSPointer',
      'component': 'MS Touch',
      'group': 'Dynamics and Interaction',
      'depends': {'component': ['Touch']},
      'baseUrl': 'parts'
    }, {
      'name': 'Legend',
      'component': 'Core',
      ...
      'group': 'Chart and Serie types',
      'depends': {'component': ['Core', 'Area', 'Spline']},
      'baseUrl': 'parts'
    }, {
      'name': 'ColumnSeries',
      'component': 'Column',
      ...
      'component': 'OHLC',
      'group': 'Stock',
      'depends': {'component': ['Stock', 'Column']},
      'baseUrl': 'parts'
    }, {
      'name': 'CandlestickSeries',
      'component': 'Candlestick',
      'group': 'Stock',
      'depends': {'component': ['Stock', 'OHLC', 'Column']},
      'baseUrl': 'parts'
    }, {
      'name': 'FlagsSeries',
      'component': 'Flags',
      ...
      'component': 'Stock',
      'group': 'Stock',
      'depends': {'component': ['Core', 'Interaction', 'Tooltip']},
      'baseUrl': 'parts'
    }, {
      'name': 'Pane',
      'baseUrl': 'parts-more'
      ...
      'name': 'RadialAxis',
      'depends': {'name': ['CenteredSeriesMixin']},
      'baseUrl': 'parts-more'
    }, {
      'name': 'AreaRangeSeries',
      'component': 'Arearange',
      'group': 'Chart and Serie types',
      'depends': {'component': ['Column', 'Area']},
      'baseUrl': 'parts-more'
    }, {
      'name': 'AreaSplineRangeSeries',
      'component': 'Areasplinerange',
      'group': 'Chart and Serie types',
      'depends': {'component': ['Arearange', 'Spline']},
      'baseUrl': 'parts-more'
    }, {
      'name': 'ColumnRangeSeries',
      'component': 'Columnrange',
      'group': 'Chart and Serie types',
      'depends': {'component': ['Core', 'Column', 'Arearange']},
      'baseUrl': 'parts-more'
    }, {
      'name': 'GaugeSeries',
      'component': 'Gauge',
      ...
      'component': 'Boxplot',
      'group': 'Chart and Serie types',
      'depends': {'component': ['Column']},
      'baseUrl': 'parts-more'
    }, {
      'name': 'ErrorBarSeries',
      'component': 'Errorbar',
      'group': 'Chart and Serie types',
      'depends': {'component': ['Boxplot']},
      'baseUrl': 'parts-more'
    }, {
      'name': 'WaterfallSeries',
      'component': 'Waterfall',
      'group': 'Chart and Serie types',
      'depends': {'component': ['Column', 'Stacking']},
      'baseUrl': 'parts-more'
    }, {
      'name': 'BubbleSeries',
      'component': 'Bubble',
      'group': 'Chart and Serie types',
      'depends': {'component': ['Core', 'Scatter']},
      'baseUrl': 'parts-more'
    }, {
      'name': 'Polar',
      'component': 'Polar',
      ...
      'component': 'Funnel',
      'group': 'Chart and Serie types',
      'depends': {'component': ['Core', 'Datalabels', 'Pie']},
      'baseUrl': 'modules'
    }, {
      'name': 'exporting.src',
      'component': 'Exporting',
      ...
      'group': 'Modules',
      'depends': {'component': ['Core', 'Exporting']},
      'baseUrl': 'modules'
    }, {
      'name': 'data.src',
      'component': 'Data',
      ...
      'group': 'Modules',
      'depends': {'component': ['Gauge']},
      'baseUrl': 'modules'
    }, {
      'name': 'HeatmapIntro',
      'component': 'Heatmap',
      'group': 'Modules',
      'depends': {'component': ['Core', 'Column', 'Scatter']},
      'baseUrl': 'parts-map'
    }, {
      'name': 'HeatmapGlobals',
      'component': 'Heatmap',
