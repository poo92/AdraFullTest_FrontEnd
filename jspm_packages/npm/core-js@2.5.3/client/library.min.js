    ...
    !function(t) {
      ...
      var i = e(2),
          ...
          a = function(t, n, e) {
            ...
            v && (e = n);
            for (s in e)
              (l = !p && m && m[s] !== r) && s in b || (h = l ? m[s] : e[s], b[s] = v && "function" != typeof m[s] ? e[s] : d && l ? u(h, i) : _ && m[s] == h ? function(t) {
      ...
      t.exports = function(t, n) {
        ...
        return function(n, f, y) {
          for (var g,
              ...
              m = c(b.length),
              w = 0,
              x = e ? v(n, m) : a ? v(n, 0) : r; m > w; w++)
            if ((p || w in b) && (g = b[w], d = S(g, w, _), t))
              if (e)
                x[w] = d;
              else if (d)
                switch (t) {
      ...
      if (e(8)) {
        var i = e(34),
            ...
            Dt = function from(t) {
              ...
              for (h && a > 2 && (l = s(l, arguments[2], 2)), n = 0, e = g(f.length), o = jt(this, e); e > n; n++)
                o[n] = h ? l(f[n], n) : f[n];
              return o;
            },
            Lt = function of() {
            ...
            Ut = {
              ...
              subarray: function subarray(t, n) {
                var e = At(this),
                    i = e.length,
                    o = _(t, i);
                return new (N(e, e[wt]))(e.buffer, e.byteOffset + o * e.BYTES_PER_ELEMENT, g((n === r ? i : _(n, i)) - o));
              }
            },
        ...
        xt || (G.f = zt, U.f = Kt), c(c.S + c.F * !xt, "Object", {
          ...
          !y || !f.ABV ? (y = e(function(t, e, i, o) {
            ...
            if (w(e)) {
              if (!(e instanceof Z || (a = m(e)) == J || a == H))
                return Ot in e ? Tt(y, e) : Dt.call(y, e);
              u = e, v = kt(i, n);
              var _ = e.byteLength;
              if (o === r) {
                if (_ % n)
            ...
            l(t, y, s);
            var u;
            return w(e) ? e instanceof Z || (u = m(e)) == J || u == H ? o !== r ? new _(e, kt(i, n), o) : i !== r ? new _(e, kt(i, n)) : new _(e) : Ot in e ? Tt(y, e) : Dt.call(y, e) : new _(d(e));
          }), tt(b !== Function.prototype ? E(_).concat(E(b)) : E(_), function(t) {
            t in y || p(y, t, _[t]);
          }), y[X] = x, i || (x.constructor = y));
          var F = x[bt],
              I = !!F && ("values" == F.name || F.name == r),
              k = Bt.values;
          p(y, mt, !0), p(x, Ot, s), p(x, Mt, !0), p(x, wt, y), (a ? new y(1)[St] == s : St in x) || V(x, St, {get: function() {
              return s;
            ...
            from: Dt,
            of: Lt
          }), Y in x || p(x, Y, n), c(c.P, s, Ut), L(s), c(c.P + c.F * It, s, {set: Vt}), c(c.P + c.F * !I, s, Bt), i || x.toString == dt || (x.toString = dt), c(c.P + c.F * u(function() {
            new y(1).slice();
      ...
      t.exports = function(t, n, e, d, _, b, S) {
        ...
        var m,
            ...
            k = !v && I || O(_),
            A = _ ? P ? O("entries") : k : r,
            j = "Array" == n ? F.entries || I : I;
        if (j && (x = h(j.call(new t))) !== Object.prototype && x.next && (l(x, M, !0), i || f(x, p) || c(x, p, g)), P && I && I.name !== y && (E = !0, k = function values() {
          return I.call(this);
        }), i && !S || !v && !E && F[p] || c(F, p, k), a[n] = k, a[M] = g, _)
          if (m = {
            values: P ? k : O(y),
            keys: b ? k : O("keys"),
            entries: A
      ...
      function packIEEE754(t, n, r) {
        var e,
            ...
            l = 0,
            h = t < 0 || 0 === t && 1 / t < 0 ? 1 : 0;
        for ((t = I(t)) != t || t === E ? (i = t != t ? 1 : 0, e = f) : (e = A(j(t) / N), t * (o = k(2, -e)) < 1 && (e--, o *= 2), (t += e + a >= 1 ? s / o : s * k(2, 1 - a)) * o >= 2 && (e++, o /= 2), e + a >= f ? (i = 0, e = f) : e + a >= 1 ? (i = (t * o - 1) * k(2, n), e += a) : (i = t * k(2, a - 1) * k(2, n), e = 0)); n >= 8; u[l++] = 255 & i, i /= 256, n -= 8)
          ;
      ...
      if (c.ABV) {
        if (!s(function() {
          ...
          for (var W,
              C = (x = function ArrayBuffer(t) {
                return l(this, x), new F(v(t));
              })[m] = F[m],
              U = y(F),
              G = 0; U.length > G; )
            (W = U[G++]) in x || f(x, W, F[W]);
          u || (C.constructor = x);
        }
        var V = new O(new x(2)),
            B = O[m].setInt8;
        V.setInt8(0, 2147483648), V.setInt8(1, 2147483649), !V.getInt8(0) && V.getInt8(1) || a(O[m], {
        ...
        }, o && (addGetter(x, T, "_l"), addGetter(O, "buffer", "_b"), addGetter(O, T, "_l"), addGetter(O, "byteOffset", "_o")), a(O[m], {
      ...
      var i = e(0),
          ...
          c = "startsWith",
          f = ""[c];
      i(i.P + i.F * e(75)(c), "String", {startsWith: function startsWith(t) {
          var n = u(this, t, c),
      ...
      var i,
          ...
          N = function(t) {
            _.call(a, function() {
              var n,
                  ...
                  u = T(t);
              if (u && (n = m(function() {
                E ? M.emit("unhandledRejection", o, t) : (e = a.onunhandledrejection) ? e({
                  promise: t,
                  reason: o
                }) : (i = a.console) && i.error && i.error("Unhandled promise rejection", o);
              }), t._h = E || T(t) ? 2 : 1), t._a = r, u && n.e)
                throw n.v;
            });
          },
          T = function(t) {
          ...
          R = function(t) {
            _.call(a, function() {
              var n;
              E ? M.emit("rejectionHandled", t) : (n = a.onrejectionhandled) && n({
                promise: t,
                reason: t._v
              });
            });
      ...
      k || (P = function Promise(t) {
        ...
        then: function then(t, n) {
          var e = I(d(this, P));
          return e.ok = "function" != typeof t || t, e.fail = "function" == typeof n && n, e.domain = E ? M.domain : r, this._c.push(e), this._a && this._a.push(e), this._s && j(this, !1), e.promise;
        },
        "catch": function(t) {
